...
def test_save_portfolio(portfolio_csv):
    ...
    'latest_price': 119.89, 'book_value': 996.6, 'market_value': 1198.9,
    'gain_loss': 202.3, 'change': 0.203}]
    portfolio_report.save_portfolio(data, filename=portfolio_csv)

    expected = ('symbol,company_name,units,cost,latest_price,book_value,market_value,'
